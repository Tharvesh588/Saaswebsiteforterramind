...
export function CTA() {
  return (
    <section className="py-20 sm:py-32 bg-gradient-to-br from-[#2E8B57] via-[#8B4513] to-[#2E8B57] relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-3xl mx-auto text-center text-white space-y-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
            <Button size="lg" variant="secondary" className="gap-2 bg-white text-[#2E8B57] hover:bg-white/90">
