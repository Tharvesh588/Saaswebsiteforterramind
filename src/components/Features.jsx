      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {features.map((feature, index) => {
            ...
            return (
              <Card key={index} className="border-2 hover:border-terramind-green/30 transition-colors hover:shadow-lg">
                <CardContent className="p-6 space-y-4">
                  <div className="h-12 w-12 bg-gradient-to-br from-terramind-green to-sky-blue rounded-lg flex items-center justify-center shadow-md">
                    <Icon className="h-6 w-6 text-white" />
                  </div>
                  <h3 className="text-xl text-charcoal-black">{feature.title}</h3>
